...
import { BannerContainer, ClockContainer, List } from "./style";
  ...
  return (
    <ClockContainer>
      ...
      <p>
        ...
        <a
          target={"_blank"}
          href="https://www.ipcc.ch/site/assets/uploads/2019/07/SPM-Portuguese-version.pdf"
        >
          relatório do IPCC
        </a>
        , o mundo inteiro precisa se unir e zerar, até 2050, as emissões de gás
        carbônico e reduzir pela metade as emissões de gás metano para previnir
        o desastre ambiental para o qual estamos nos dirigindo e termos a chance
        de amenizar os impactos das mudanças climáticas no planeta. Para termos
        essa chance, precisamos reduzir em, no mínimo, 43% as emissões de CO2
        até 2030.
      </p>
      <Banner />
      {/* <p>De acordo com o último <a target={"_blank"} href="https://www.ipcc.ch/site/assets/uploads/2019/07/SPM-Portuguese-version.pdf">relatório do IPCC</a>, o mundo inteiro precisa se unir e zerar, até 2050, as emissões de gás carbônico e reduzir pela metade as emissões de gás metano para previnir o desastre ambiental para o qual estamos nos dirigindo e termos a chance de amenizar os impactos das mudanças climáticas no planeta. Para termos essa chance, precisamos reduzir em, no mínimo, 43% as emissões de CO2 até 2030.</p>
        <p>O Relógio do Agora marca quanto tempo temos para agir e salvar nosso lar.</p>
